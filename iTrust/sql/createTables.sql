...
CREATE TABLE patients(
	...
	ObstetricEligibe BOOLEAN NOT NULL default false,
	PRIMARY KEY (MID)
) ENGINE=MyISAM;
...
(
	...
	LMP				        DATE,
	EDD               DATE,
	weekPregnant	    VARCHAR(4) default '',
	concepYear		    INT(4) default 0,
	hrsLabor		      FLOAT default 0,
	weightGain		    FLOAT default 0,
	weight            FLOAT default 0,
	bloodPressureL    INT default 0,
	bloodPressureH    INT default 0,
	FHR               INT default 0,
	deliveryType	    ENUM ('Vaginal Delivery', 'Vaginal Delivery Vacuum Assist', 'Vaginal Delivery Forceps Assist', 'Caesarean Section', 'Miscarriage') default 'Vaginal Delivery',
	pregnancyStatus   ENUM('Initial', 'Complete', 'OfficeVisit') default 'Initial',
	multiPregnancy	  BOOLEAN NOT NULL default false,
	babyCount		      INT(2) default 0,
	lyingPlacenta     BOOLEAN NOT NULL default false,
...
(
	...
	fetusID         BIGINT(20),
	visitDate DATE,
  crownRumpLength FLOAT default 0,
  biparietalDiameter FLOAT default 0,
  headCircumference FLOAT default 0,
  femurLength FLOAT default 0,
  occipitofrontalDiameter FLOAT default 0,
  abdominalCircumference FLOAT default 0,
  humerusLength FLOAT default 0,
  estimatedFetalWeight FLOAT default 0,
	PRIMARY KEY (id)
) ENGINE=MyISAM;

CREATE TABLE ultrasoundImage
(
	MID 			      BIGINT		UNSIGNED NOT NULL default '0',
	fetusID         BIGINT(20),
	ultrasoundImage LONGBLOB,
	PRIMARY KEY (MID, fetusID)
) ENGINE=MyISAM;
...
CREATE TABLE childbirth
(
	id 				        BIGINT(20) 		UNSIGNED AUTO_INCREMENT,
	MID 			        BIGINT		UNSIGNED NOT NULL default '0',
	visitDate		      	DATE,
	visitType			ENUM ('Pre-scheduled', 'ER') default 'Pre-scheduled',
	deliveryType	    ENUM ('Vaginal Delivery', 'Vaginal Delivery Vacuum Assist', 'Vaginal Delivery Forceps Assist', 'Caesarean Section', 'Miscarriage') default 'Vaginal Delivery',
	pitocin				BOOLEAN NOT NULL default false,
	pitocinDosage		FLOAT default 0,
	nitrousOxide		BOOLEAN NOT NULL default false,
	nitrousOxideDosage	FLOAT default 0,
	pethidine			BOOLEAN NOT NULL default false,
	pethidineDosage		FLOAT default 0,
	epiduralAnaesthesia				BOOLEAN NOT NULL default false,
	epiduralAnaesthesiaDosage		FLOAT default 0,
	magnesiumSulfate				BOOLEAN NOT NULL default false,
	magnesiumSulfateDosage		FLOAT default 0,
	rhImmuneGlobulin				BOOLEAN NOT NULL default false,
	rhImmuneGlobulinDosage		FLOAT default 0,
	babyID		      INT(2) default 1,
	deliveryTime		DATE,
