...
public enum TransactionType {
	...
	/**CREATE_INITIAL_ULTRASOUND_RECORD**/
	CREATE_INITIAL_ULTRASOUND_RECORD(9100, "Create Initial Ultrasound Record", "Create Initial Ultrasound Record", true),
	...
	/**CREATE_INITIAL_CHILDBIRTH_RECORD**/
	CREATE_INITIAL_CHILDBIRTH_RECORD(9500, "Create Initial Childbirth Record", "Create Initial Childbirth Record", true),
	...
	/**CREATE_INITIAL_CHILDBIRTH_RECORD**/
	CREATE_PREGNANCY_REPORT(9501, "Create Pregancy Report", "Create Pregancy Report", true),

	CREATE_INFANT_CARE_RECORD(9700, "Create Infant Care Record", "Create Infant Care Record", true),

	EDIT_INFANT_CARE_RECORD(9701, "Edit Infant Care Record", "Edit Infant Care Record", true),

	VIEW_INFANT_CARE_RECORD(9702, "View Infant Care Record", "View Infant Care Record", true),

	VIEW_INFANT_VACCINES_IMMUNIZATION_RECORD(9703, "View Infant Vaccines Immunization Record", "View Infant Vaccines Immunization Record", true)
	;
