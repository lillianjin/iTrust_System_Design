...
//	}
	...
	/**
	 * Gets the DAO for obstetrics record with the DB table obstetrics
	 * @return this DAOFactory's ObstetricsRecordDAO
	 */
	public ObstetricsRecordDAO getObstetricsRecordDAO() { return new ObstetricsRecordDAO(this); }


	/**
	 * Gets the DAO for ultrasound record with the DB table ultrasound
	...
	/**
	 * Gets the DAO for infant visit with the DB table infantVisit
	 * @return this DAOFactory's UltrasoundRecordDAO
	 */
	public InfantVisitRecordDAO getInfantVisitRecordDAO() { return new InfantVisitRecordDAO(this); }


	/**
	 * Gets the DAO for childbirth record with the DB table childbirth
	 * @return this DAOFactory's UltrasoundRecordDAO
	 */
	public ChildbirthRecordDAO getChildbirthRecordDAO() { return new ChildbirthRecordDAO(this); }
