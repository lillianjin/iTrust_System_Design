...
public class TestDataGenerator {
	...
	/**
	 * generate the dependency data for obstetrics
	 */
	public void addObstetrics() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/obstetrics.sql");
	}

	/**
	 * generate the dependency data for infant office visit
	 */
	public void addInfantVisit() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/infantVisit.sql");
	}
