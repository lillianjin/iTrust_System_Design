...
import edu.ncsu.csc.itrust.action.AddChildbirthAction;
...
public class AddChildbirthActionTest extends TestCase {
    public void test() throws Exception {
        DAOFactory prodDAO = TestDAOFactory.getTestInstance();
        AddChildbirthAction acbAction = new AddChildbirthAction(prodDAO, 9000000012L);
        ...
        assertEquals(806L, acbAction.addChildbirthRecord(bean));
    }
}
